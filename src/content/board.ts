...
export const board = {
  ...
  roles: [
    ...
    },
    {
      ...
      bioPhotoScale: 1,
      bioPhotoOffsetX: 35,
      bio: "Luana Case is a Finance and Accounting student at Northeastern University. She serves as Director of Education at the Equity Research Group, where she designs onboarding for new members and leads skill sessions in financial modeling, valuation, and memo writing. She also covers the Fintech sub-sector under the Financials industry.",
      email: "case.l@northeastern.edu",
      linkedin: "https://www.linkedin.com/in/luana-case/",
    },
    {
